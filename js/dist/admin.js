...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  app.routes['reflar-gamification'] = {
    path: '/reflar/gamification',
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_AdminNav__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'items', function (items) {
    items.add('reflar-gamification', flarum_components_AdminLinkButton__WEBPACK_IMPORTED_MODULE_2___default.a.component({
...
/*#__PURE__*/
function (_Page) {
  Object(_babel_runtime_helpers_es6_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(SettingsPage, _Page);
  ...
  _proto.view = function view() {
    ...
    return [m('div', {
      ...
      className: 'helpText'
    }, app.translator.trans('reflar-gamification.admin.page.convert.help')), this.values.convertedLikes() === undefined ? flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      type: 'button',
    ...
    }) : this.values.convertedLikes() === 'converting' ? m('label', {}, app.translator.trans('reflar-gamification.admin.page.convert.converting')) : m('label', {}, app.translator.trans('reflar-gamification.admin.page.convert.converted', {
      number: this.values.convertedLikes()
    })), m('fieldset', {
      className: 'SettingsPage-ranks'
    }, [m('legend', {}, app.translator.trans('reflar-gamification.admin.page.ranks.title')), m('label', {}, app.translator.trans('reflar-gamification.admin.page.ranks.ranks')), m('div', {
      className: 'helpText'
    }, app.translator.trans('reflar-gamification.admin.page.ranks.help.help')), m('div', {
    ...
    }), m('legend', {}, app.translator.trans('reflar-gamification.admin.page.votes.title')), m('label', {}, app.translator.trans('reflar-gamification.admin.page.votes.icon_name')), m('div', {
      className: 'helpText'
    }, app.translator.trans('reflar-gamification.admin.page.votes.icon_help')), m('input', {
      className: 'FormControl Ranks-default',
    ...
    }), m('legend', {}, app.translator.trans('reflar-gamification.admin.page.rankings.title')), flarum_components_Switch__WEBPACK_IMPORTED_MODULE_6___default.a.component({
      ...
      className: 'helpText'
    }, app.translator.trans('reflar-gamification.admin.page.rankings.blocked.help')), m('label', {
      className: 'Upload-label'
    }, app.translator.trans('reflar-gamification.admin.page.rankings.custom_image_1')), m(flarum_components_UploadImageButton__WEBPACK_IMPORTED_MODULE_4___default.a, {
      className: "Upload-button",
      name: "topimage1"
    }), m('br'), m('label', {
      className: 'Upload-label'
    }, app.translator.trans('reflar-gamification.admin.page.rankings.custom_image_2')), m(flarum_components_UploadImageButton__WEBPACK_IMPORTED_MODULE_4___default.a, {
      className: "Upload-button",
      name: "topimage2"
    }), m('br'), m('label', {
      className: 'Upload-label'
    }, app.translator.trans('reflar-gamification.admin.page.rankings.custom_image_3')), m(flarum_components_UploadImageButton__WEBPACK_IMPORTED_MODULE_4___default.a, {
      className: "Upload-button",
      name: "topimage3"
...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('reflar-gamification', function (app) {
