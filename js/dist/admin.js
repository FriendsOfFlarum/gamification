...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  app.extensionSettings['fof-gamification'] = function () {
    return m.route.set(app.route('fof-gamification'));
  };
...
/* harmony import */ var flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! flarum/utils/withAttr */ "flarum/utils/withAttr");
/* harmony import */ var flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5__);
...
var SettingsPage = /*#__PURE__*/function (_Page) {
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.fields.forEach(function (key) {
      return _this.values[key] = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_6___default()(settings[_this.addPrefix(key)]);
    });
    this.switches.forEach(function (key) {
      return _this.values[key] = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_6___default()(!!Number(settings[_this.addPrefix(key)]));
    });
    this.newRank = {
      points: flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_6___default()(''),
      name: flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_6___default()(''),
      color: flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_6___default()('')
    };
  }
  /**
   * @returns {*}
  ...
  _proto.view = function view() {
    ...
    return [m('div', {
      ...
      className: 'helpText'
    }, app.translator.trans('fof-gamification.admin.page.convert.help')), this.values.convertedLikes() === undefined ? flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      type: 'button',
      ...
      return m('div', {
        ...
        oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', _this2.updatePoints.bind(_this2, rank))
      }), m('input', {
        className: 'FormControl Ranks-name',
        value: rank.name(),
        placeholder: app.translator.trans('fof-gamification.admin.page.ranks.help.name'),
        oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', _this2.updateName.bind(_this2, rank))
      }), m('input', {
        className: 'FormControl Ranks-color',
        value: rank.color(),
        placeholder: app.translator.trans('fof-gamification.admin.page.ranks.help.color'),
        oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', _this2.updateColor.bind(_this2, rank))
      ...
      placeholder: app.translator.trans('fof-gamification.admin.page.ranks.help.points'),
      type: 'number',
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', this.newRank.points)
    }), m('input', {
      className: 'FormControl Ranks-name',
      value: this.newRank.name(),
      placeholder: app.translator.trans('fof-gamification.admin.page.ranks.help.name'),
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', this.newRank.name)
    }), m('input', {
      className: 'FormControl Ranks-color',
      value: this.newRank.color(),
      placeholder: app.translator.trans('fof-gamification.admin.page.ranks.help.color'),
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', this.newRank.color)
    }), flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      type: 'button',
      className: 'Button Button--warning Ranks-button',
      icon: 'fa fa-plus',
      ...
      placeholder: 2,
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', this.values.rankAmt)
      ...
      placeholder: 'thumbs',
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', this.values.iconName)
    ...
    }, app.translator.trans('fof-gamification.admin.page.votes.auto_upvote')), flarum_components_Switch__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      state: this.values.rateLimit() || false,
      onchange: this.values.rateLimit,
      className: 'votes-switch'
    }, app.translator.trans('fof-gamification.admin.page.votes.rate_limit')), flarum_components_Switch__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      state: this.values.showVotesOnDiscussionPage() || false,
      onchange: this.values.showVotesOnDiscussionPage,
      className: 'votes-switch'
    }, app.translator.trans('fof-gamification.admin.page.votes.discussion_page')), flarum_components_Switch__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', this.values.pointsPlaceholder)
    }), m('legend', {}, app.translator.trans('fof-gamification.admin.page.rankings.title')), flarum_components_Switch__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', this.values.blockedUsers)
    }), m('div', {
      className: 'helpText'
...
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_components_UploadImageButton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/components/UploadImageButton */ "flarum/components/UploadImageButton");
/* harmony import */ var flarum_components_UploadImageButton__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_components_UploadImageButton__WEBPACK_IMPORTED_MODULE_1__);
...
}(flarum_components_UploadImageButton__WEBPACK_IMPORTED_MODULE_1___default.a);
